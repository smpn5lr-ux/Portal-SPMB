    ...
    try {
      const result = await generateAdmissionJustification({
        ...
        selectionCriteria: {
          ...
          prestasiMinScore: 80,
          affirmationCategoriesAllowed: ['Ekonomi Kurang Mampu'],
        },
        quotaRules: {
          totalQuota: 250,
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <Badge variant="outline" className="text-primary border-primary/20">#{applicant.registrationSequence || '-'}</Badge>
            </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="border-border/50 shadow-sm overflow-hidden">
            <CardHeader className="flex flex-row items-center justify-between pb-4 border-b bg-muted/20">
              ...
              <Badge className="font-bold">{applicant.verificationStatus}</Badge>
            </CardHeader>
          ...
          <Card className="border-border/50 shadow-sm">
            ...
            <CardContent>
              {justification ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center bg-muted/20 rounded-xl border border-dashed"><Sparkles className="w-12 h-12 text-muted-foreground/30 mb-4" /><p className="text-sm text-muted-foreground">Klik tombol di atas untuk membuat analisis seleksi otomatis.</p></div>
              )}
            </CardContent>
          </Card>
        </div>
